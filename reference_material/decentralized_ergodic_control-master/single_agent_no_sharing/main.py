...
def main():
    ...
    while simulation_time < final_simulation_time:
        ...
        # agents[0].objective.target_distribution.update_phik(simulation_time)
        # for agent in agents:
            # agent.objective.target_distribution.phik = agents[0].objective.target_distribution.phik.copy()
        print('\nTime : {}'.format(simulation_time))

    # print('saving agent data...')
    for i,agent in enumerate(agents):
        agent.save('obstacle_trial1/agent{}.npy'.format(i))
