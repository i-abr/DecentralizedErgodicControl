...
def animate(i):
    ...
    for agent_no in range(num_agents):
        ...
        quads[agent_no]['l1'].set_zorder(9)
        ...
        quads[agent_no]['l2'].set_zorder(9)
        ...
        quads[agent_no]['height'].set_zorder(8)
        if i > 50:
            ...
            quads[agent_no]['trajectory'].set_zorder(8)
...
anim.save('obstacle_trial3/obstacle_time_varying.mp4', fps=30)
plt.show()
