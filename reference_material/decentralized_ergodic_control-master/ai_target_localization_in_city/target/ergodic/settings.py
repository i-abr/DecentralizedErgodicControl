import numpy as np
from system_dynamics import DoubleIntegrator
...
class Settings(object):
    ...
    def __init__(self, time_step=0.05):
        ...
        self.Qf = self.Q*0.0
        self.R = np.diag([0.1]*2)
        self.ergodic_dim = 2
        self.umax = [[-0.2,-0.2],[0.2,0.2]]
        self.xlim = [[0.0,1.0]]*self.ergodic_dim
        self.u0 = np.array([0.,0.])
        self.max_iter = 20
        self.ergodic_memory = 20
        ...
        self.system_model = DoubleIntegrator(self.time_step)
