...
class QuadcopterAgent(object):
    ...
    def __init__(self):
        ...
        Q, R = np.diag([0.00,0.00,20.] + [0.05]*9), np.diag([0.1,0.1,0.1,0.1])
        ...
        # self.state[0] = np.random.uniform(0.1, 0.2)
        # self.state[1] = np.random.uniform(0.1, 0.2)
        # self.state[2] = np.random.uniform(0.5, 0.8)

        # self.state[0] = np.random.uniform(0.1, 0.3)
        # self.state[1] = np.random.uniform(0.7, 0.8)
        self.state[0] = np.random.uniform(0.2, 0.3)
        self.state[1] = np.random.uniform(0.1, 0.2)
